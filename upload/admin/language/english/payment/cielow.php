<?php
// Heading
$_['heading_title']		             = 'Cielo Webservice';

// Text
$_['text_payment']		             = 'Pagamentos';
$_['text_success']		             = 'Pagamento por Cielo Webservice modificado com sucesso!';
$_['text_edit']                      = 'Configurações do pagamento por Cielo Webservice';
$_['text_cielow']			         = '<a target="_BLANK" href="https://www.cielo.com.br/ecommerce"><img src="view/image/payment/cielo.jpg" alt="Cielo Webservice" title="Cielo Webservice" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['text_campo']	                 = 'Campo:';
$_['text_nao_personalizado']	     = 'Não personalizado';
...
$_['tab_campos']                     = 'Campos para antifraudes';
$_['tab_clearsale']                  = 'ClearSale';
$_['tab_fcontrol']                   = 'FControl';
...
$_['entry_layout']                   = 'Layout do formulário';
...
$_['help_soft_descriptor']	         = 'Texto com até 13 caracteres que será impresso na fatura do cartão de crédito para que o cliente identifique a origem da cobrança. O texto não deve conter espaço, sinais de pontuação, acentuação ou ç.';
...
$_['help_captura']	                 = 'Tipo de captura da transação de pagamento. Se você trabalhar com sistema antifraude, utilize a opção Manual, para autorizar e posteriormente capturar.';
...
$_['help_layout']                    = 'Layout do formulário de pagamento que será exibido na finalziação do pedido.';
...
// Error
$_['error_permission']	             = 'Atenção: Você não tem permissão para modificar a extensão Cielo Webservice!';
$_['error_credenciamento']           = 'O campo Nº credenciamento é obrigatório!';
$_['error_chave']                    = 'O campo Chave de acesso é obrigatório!';
$_['error_soft_descriptor']          = 'O campo Identificação na fatura é obrigatório!';
